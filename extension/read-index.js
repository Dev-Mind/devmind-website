...
function extReadIndex() {
    var _this = this;
    return map_stream_1.mapStream(function (file, next) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
        return [2 /*return*/, next(null, JSON.parse(file.contents))];
    }); }); });
}
